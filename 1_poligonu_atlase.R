...
st_layers("./IevadesDati/riga_35km_radius.gpkg")

# Teritorijas sagatavošana un pārprojekcija
atlases_telpa = st_read("./IevadesDati/riga_35km_radius.gpkg", layer = "km35_radius")
...
write_sf(prove_poly,"./IevadesDati/poligoni_720730.gpkg",layer="Poligoni_darbam",append=FALSE)




# 5. Atlases sadalījuma sagatavošana ----
sadalijums <- st_read("./IevadesDati/riga_sadalijums.gpkg")
