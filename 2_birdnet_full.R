...
audio_folder <- "../AudioMoth/ML_Q1_M1"
...
ierakstu_faili=data.frame(celi=list.files("../AudioMoth/",full.names = TRUE),
...
audio_folder <- "../AudioMoth/ML_Q1_L"
...
audio_folder <- "../AudioMoth/ML_Q1_M2"
...
audio_folder <- "../AudioMoth/ML_Q1_M3"
...
audio_folder <- "../AudioMoth/ML_Q1_M4"
...
audio_folder <- "../AudioMoth/ML_Q1_M5"
...
audio_folder <- "../AudioMoth/ML_Q2_L"
...
audio_folder <- "../AudioMoth/ML_Q2_M1"
...
audio_folder <- "../AudioMoth/ML_Q2_M2"
...
audio_folder <- "../AudioMoth/ML_Q2_M3"
...
audio_folder <- "../AudioMoth/ML_Q2_M4"
...
audio_folder <- "../AudioMoth/ML_Q2_M5"
...
audio_folder <- "../AudioMoth/ML_Q3_L"
...
audio_folder <- "../AudioMoth/ML_Q3_M1"
...
audio_folder <- "../AudioMoth/ML_Q3_M3"
...
audio_folder <- "../AudioMoth/ML_Q3_M4"
...
audio_folder <- "../AudioMoth/ML_Q3_M5"
...
audio_folder <- "../AudioMoth/ML_Q4_L"
...
audio_folder <- "../AudioMoth/ML_Q4_M1"
...
audio_folder <- "../AudioMoth/ML_Q4_M2"
...
audio_folder <- "../AudioMoth/ML_Q4_M3"
...
audio_folder <- "../AudioMoth/ML_Q4_M4"
...
### X. META REZULTĀTU APSTRĀDE (vai nepieciesams?) ----

results_list_meta_clean <- lapply(
  results_list_meta,
  process_meta_result
)

results_meta <- bind_rows(
  lapply(seq_along(results_list_meta_clean), function(i) {
    
    df <- results_list_meta_clean[[i]]
    
    if (nrow(df) > 0) {
      df %>%
        mutate(
          audio_file = file_info$audio_file[i],
          quadrant   = file_info$quadrant[i],
          mic_type = file_info$mic_type[i],
